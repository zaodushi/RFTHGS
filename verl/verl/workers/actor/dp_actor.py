                ...
                for data in micro_batches:
                    ...
                    if self.config.policy_loss.loss_mode == "vanilla":
                        ...
                        pg_loss, pg_clipfrac, ppo_kl, pg_clipfrac_lower = policy_loss_fn(
                            old_log_prob, log_prob, advantages, response_mask, loss_agg_mode, loss_scale_factor, self.config
                        )

                    if entropy_coeff != 0:
                        entropy_loss = agg_loss(loss_mat=entropy, loss_mask=response_mask, loss_agg_mode=loss_agg_mode, loss_scale_factor=loss_scale_factor)
                    ...
                    if self.config.use_kl_loss:
                        ...
                        kl_loss = agg_loss(loss_mat=kld, loss_mask=response_mask, loss_agg_mode=loss_agg_mode, loss_scale_factor=loss_scale_factor)
